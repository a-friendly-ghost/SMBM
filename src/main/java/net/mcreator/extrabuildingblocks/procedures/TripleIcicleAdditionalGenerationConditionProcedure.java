...
public class TripleIcicleAdditionalGenerationConditionProcedure {
	public static boolean execute(LevelAccessor world, double x, double y, double z) {
		world.setBlock(BlockPos.containing(x, y - 1, z), (blockStateWithEnum(ExtraBuildingBlocksModBlocks.ICICLE.get().defaultBlockState(), "thickness", "frustum")), 3);
		world.setBlock(BlockPos.containing(x, y - 2, z), (blockStateWithEnum(ExtraBuildingBlocksModBlocks.ICICLE.get().defaultBlockState(), "thickness", "tip")), 3);
		return true;
	}
